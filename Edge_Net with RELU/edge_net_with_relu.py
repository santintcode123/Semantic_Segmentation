...
def EdgeNet():
  ...
  e1 = tf.keras.layers.Conv2D(16, (3,3), padding="same", activation="relu" )( inputs )
  e2 = tf.keras.layers.Conv2D(32, (3,3), padding="same", activation="relu" )( e1 )
...
edge_model.save('Edge_Net_with_RELU.h5')
